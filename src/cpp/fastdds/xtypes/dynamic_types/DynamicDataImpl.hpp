...
struct DataState
{
    ...
    eprosima::fastrtps::rtps::octet byte_value_ = 0;
...
public:
    ...
    static const DynamicDataImpl& get_implementation(
            const DynamicData& t)
    {
    ...
    static DynamicDataImpl& get_implementation(
            DynamicData& t)
    {
...
public:
     ...
     * @return standard DDS @ref ReturnCode_t
     */
    //TODO(richiware) whay default for memberid
    ...
    ReturnCode_t get_int8_value(
            ...
            MemberId id = MEMBER_ID_INVALID) const
    {
        eprosima::fastrtps::rtps::octet aux;
    ...
    ReturnCode_t set_int8_value(
            ...
            MemberId id = MEMBER_ID_INVALID)
    {
        return set_byte_value(static_cast<eprosima::fastrtps::rtps::octet>(value), id);
    }
     ...
     */
    eprosima::fastrtps::rtps::octet get_byte_value(
            MemberId id = MEMBER_ID_INVALID) const
    {
        eprosima::fastrtps::rtps::octet value;
