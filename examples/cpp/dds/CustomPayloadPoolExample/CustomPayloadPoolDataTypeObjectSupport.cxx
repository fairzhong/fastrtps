...
void register_CustomPayloadPoolData_type_objects()
{
...
{
    {
        ...
        QualifiedTypeName type_name = "CustomPayloadPoolData";
        ...
        return_code =
            eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
            "CustomPayloadPoolData", type_ids);
        if (return_code != eprosima::fastdds::dds::RETCODE_OK)
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                        "CustomPayloadPoolData: Given Struct TypeIdentifier unknown to TypeObjectRegistry.");
            return;
        }
    }
}
