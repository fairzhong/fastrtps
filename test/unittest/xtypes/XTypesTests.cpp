...
/*TODO(richiware)
   ...
   {
    std::unique_ptr<DynamicTypeBuilder> my_builder {DynamicTypeBuilderFactory::get_instance().create_struct_type()};
    my_builder->add_member({0_id, "x", DynamicTypeBuilderFactory::get_instance().get_float32_type()});
    my_builder->add_member({0_id, "y", DynamicTypeBuilderFactory::get_instance().get_float32_type()});
    my_builder->add_member({0_id, "z", DynamicTypeBuilderFactory::get_instance().get_float32_type()});
